...
{ARITH_OP} 		{return new Symbol(sym.ARITH_OP);}
{ASSIGN_OP}		{return new Symbol(sym.ASSIGN_OP);}
{REL_OP} 		{return new Symbol(sym.REL_OP);}
{BIT_OP} 		{return new Symbol(sym.BIT_OP);}
